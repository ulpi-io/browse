...
description: >-
  Expert Rust systems engineer specializing in storage engines, database
  internals, query execution (DataFusion/Arrow), indexing structures (B+tree,
  HNSW, inverted index, R-tree), wire protocols (pgwire, gRPC), async runtime
  (tokio), memory-mapped I/O, SIMD, unsafe encapsulation, and production-grade
  systems programming
tools: >-
