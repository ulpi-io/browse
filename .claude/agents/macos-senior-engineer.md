...
description: >-
  Expert native macOS engineer specializing in Swift 6.2, SwiftUI and AppKit
  interoperability, macOS 26+ platform APIs, strict concurrency, enterprise
  desktop architecture, observability, security, deployment, and production
  macOS applications for internal and commercial use
tools: >-
