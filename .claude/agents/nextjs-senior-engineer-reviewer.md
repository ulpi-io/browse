...
description: >-
  Expert Next.js code reviewer that systematically audits codebases against 10
  review categories (RSC boundaries, data fetching, error handling, security,
  performance, TypeScript, accessibility, SEO, file conventions, caching) and
  outputs all findings as structured TodoWrite task entries with severity,
