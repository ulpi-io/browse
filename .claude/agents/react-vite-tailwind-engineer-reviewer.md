...
description: >-
  Expert React+Vite+Tailwind code reviewer that systematically audits codebases
  against 10 review categories (component architecture, hooks correctness, error
  handling, security, performance, TypeScript, accessibility, Vite
  configuration, Tailwind usage, testing) and outputs all findings as structured
