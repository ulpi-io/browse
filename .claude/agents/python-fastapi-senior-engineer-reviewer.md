...
description: >-
  Expert FastAPI code reviewer that systematically audits codebases against 10
  review categories (dependency injection, Pydantic models, database patterns,
  authentication & security, error handling, middleware, testing, API design,
  performance, deployment) and outputs all findings as structured TodoWrite task
